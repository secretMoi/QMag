...
namespace Controls
{
    public partial class FlatListBox : UserControl
    {
        ...
        private readonly Image _menuFerme = Image.FromFile("Ressources/Images/down-arrow.png");
        private readonly Image _menuOuvert = Image.FromFile("Ressources/Images/up-arrow.png");
        ...
        public void Add(string text, EventHandler click = null)
        {
            ...
            if (_elements.Count < _nbElementsMax)
            {
